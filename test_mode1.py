...
def main():
    stego = Stego()
    img = r"C:\Users\65011\Desktop\Segano\work00002\photoexample\pic_old\example4.png"
    audio = r"C:\Users\65011\Desktop\Segano\work00002\audioexample\mp3.mp3"
    secret = "mikkeesaหฟกหฟก__321115"
    out_img = r"C:\Users\65011\Desktop\Segano\work00002\output_files\test01.png"
    out_audio_dir = r"C:\Users\65011\Desktop\Segano\work00002\output_files"

    print("[START] Running steganography experiment...")
    res = stego.hide(img, audio, secret, out_img, out_audio_dir)

    if res["success"]:
        print("\n[SUCCESS] Data hidden successfully!")
        extracted = stego.extract(res["output_image"], res["output_audio"], res["key_base64"])
        if extracted == secret:
            print("[RESULT] Success! Extracted matches original.")
        else:
            print("[RESULT] Failed! Extracted does not match.")
    else:
        print("[FAILURE] Failed to hide data.")
